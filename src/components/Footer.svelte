<script>
    import Icon from "$lib/assets/Logos.png"
</script>
...
<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
    <div class="max-w-[1200px] mx-auto w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-base">
        <div class="flex flex-col gap-4 md:col-span-2">
            <img src={Icon} alt="Randumb Fitness" width="300px" height="300px">
            <p>©2023 SWOLEY MOLEY LTD. All rights reserved.</p>
        </div>
        <div class="flex flex-col gap-4">
            <p class="font-bold poppins text-base sm:text-lg">Support</p>
            <a href="" target="_blank" class="cursor-pointer hover:text-blue-400 duration-200">
                Contact Us
            </a>
        </div>
        <div class="flex flex-col gap-4">
            ...
            <a href="" target="_blank" class="cursor-pointer hover:text-blue-400 duration-200">
                <i class="fa-brands fa-instagram pr-2"></i> Instagram
            </a>
            <a href="" target="_blank" class="cursor-pointer hover:text-blue-400 duration-200">
                <i class="fa-brands fa-youtube pr-2"></i> Youtube
            </a>
            <a href="" target="_blank" class="cursor-pointer hover:text-blue-400 duration-200">
                <i class="fa-brands fa-discord pr-2"></i> Discord
            </a>
        </div>
    </div>
</footer>